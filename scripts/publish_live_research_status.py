...
payload={"schema_version":"1.1","cycle_id":manifest.get("cycle_id"),"updated_at":now,"active_tasks":active}
active_path.write_text(json.dumps(payload,ensure_ascii=False,indent=2),encoding="utf-8")
status_path.write_text(json.dumps({
    "schema_version":"1.1","updated_at":now,"cycle_id":manifest.get("cycle_id"),
    "worker":"github-public-web","worker_status":"RUNNING","phase":"SEARCH",
    "selected_tasks":len(active),"active_tasks":active,"execution":"MEASURED"
