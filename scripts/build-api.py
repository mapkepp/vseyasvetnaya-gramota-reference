...
bukovy=json.loads((ROOT/"data"/"bukovy.json").read_text("utf-8")); practices=json.loads((ROOT/"data"/"practices.json").read_text("utf-8")); histories=json.loads((ROOT/"data"/"practice"/"practitioner-histories.json").read_text("utf-8")); recovery_pages=json.loads((ROOT/"data"/"recovery"/"historical-six-pages.json").read_text("utf-8")); recovery_candidates=json.loads((ROOT/"data"/"recovery"/"147-candidates.json").read_text("utf-8")); recovery_evidence=json.loads((ROOT/"data"/"recovery"/"secondary-evidence.json").read_text("utf-8")); practical_coverage=json.loads((ROOT/"data"/"practical-coverage.json").read_text("utf-8")); research_status_path=ROOT/"data"/"research"/"autonomous-status.json"; research_queue_path=ROOT/"data"/"research"/"autonomous-queue.json"; research_status=json.loads(research_status_path.read_text("utf-8")) if research_status_path.is_file() else {"status":"NOT_INITIALIZED"}; research_queue=json.loads(research_queue_path.read_text("utf-8")) if research_queue_path.is_file() else {"tasks":[]}
