...
for n,o in [("bukovy.json",bukovy),("practices.json",practices),("practitioner-histories.json",histories),("practical-coverage.json",practical_coverage),("index.json",index),("bukovy-manifest.json",manifest),("recovery.json",recovery)]: (api/n).write_text(json.dumps(o,ensure_ascii=False,indent=2)+"\n","utf-8")
